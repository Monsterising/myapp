...
function fetchData(key, page) {
    var url = "";
    if (page == 0)
        url = 'http://www.mwr.gov.cn/slzx/slyw/index.html';
    else
        url = 'http://www.mwr.gov.cn/slzx/slyw/index_' + page + '.html';
        ...
        $('#ul_slb3').each(function () {
            ...
            var info = {};
                info = {
                    ...
                    "url": "http://www.mwr.gov.cn/slzx/slyw" + $(this).find('a').attr("href").replace("./", "/"),
